...
def get_values(*args):
    """
    commentaire  get_values commentaire  get_values commentaire
    
    :param freq.get(): description...........
    :param unit.get(): description........
    :param ampli.get(): description..........
    :param offset.get(): description.............
    :param type_sig.get(): description......
    """
...
def send_cmds():
    ...
    commentaire  send_cmds commentaire  send_cmds commentaire  send_cmds
    
    :param cmds: es una variable que envia los parametros...
    :var frq: abcdefgh
    """
...
def close():
    """
    commentaire  close commentaire  close commentaire  close
    """
